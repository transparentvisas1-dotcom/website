    ...
    <main className="pb-24">
      ...
      <section className="relative w-full h-[400px] md:h-[500px] flex flex-col justify-center items-center text-center mb-24 px-margin-mobile md:px-margin-desktop overflow-hidden border-b border-burnished-gold/10">
        <div className="absolute inset-0 z-0">
          <img src="/passport.jpg" alt="Countries Banner" className="w-full h-full object-cover object-center opacity-40" />
      ...
      <section className="px-margin-mobile md:px-margin-desktop w-full max-w-container-max mx-auto space-y-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {/* USA */}
          <div className="bg-charcoal-surface border border-outline-variant/30 rounded-xl p-8 lg:p-12 glow-hover">
            ...
            <Link href="/contact" className="text-champagne-highlight font-label-md uppercase tracking-widest hover:text-burnished-gold transition-all inline-flex items-center gap-2">
        ...
        {/* GCC Countries */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          <div className="bg-charcoal-surface border border-outline-variant/30 rounded-xl p-8 lg:p-12 glow-hover sticky top-32 md:order-last">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-12">
          <div className="bg-charcoal-surface border border-outline-variant/30 rounded-xl p-8 text-center glow-hover">
            ...
            <Link href="/contact" className="text-champagne-highlight font-label-md uppercase tracking-widest hover:text-burnished-gold transition-all inline-flex items-center justify-center gap-2">
